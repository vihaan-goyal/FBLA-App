...
- RyiSnow - "How to Make a 2D Game in Java" YouTube series. Used as the foundation for the core game engine (game loop, tile rendering, collision detection, and entity movement). All pet care, quest, quiz, economy, and UI systems were built originally on top of this base. In addition, we used some opensource pixel art images. The rest were created by our team.
